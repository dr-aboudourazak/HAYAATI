...
class FinancialEngine:
    ...
    def _calculer_metriques_zakat_atomiq(self, liq, stock, or_ref, or_par, 
        ...
        dettes_totales_a_deduire = float(dettes or 0.0)
        if doc in ["Hanbalite", "Chafiite", "Chafi'ite", "Shafi'ite"]:
            dettes_totales_a_deduire += float(dettes_spirituelles or 0.0)
        ...
        return {
            ...
            "dettes_humaines_deduites": float(dettes or 0.0),
            "dettes_spirituelles_deduites": float(dettes_spirituelles or 0.0),
