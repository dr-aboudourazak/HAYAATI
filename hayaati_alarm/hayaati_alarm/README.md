...
hayaati-alarm [Flet](https://flet.dev) extension.
...
Add `hayaati-alarm` dependency to the `pyproject.toml` of your Flet project:

* **From Git**

```toml
dependencies = [
  "hayaati-alarm @ git+https://github.com/MY_GITHUB_ACCOUNT/hayaati-alarm",
  "flet>=0.86.2",
]
```
...
Detailed documentation for this package can be found [here](https://MY_GITHUB_ACCOUNT.github.io/hayaati-alarm/).
