...
class EcranHeritage(ft.Container):
    def __init__(self, app_reference):
        ...
        # 🎯 FIX TECHNIQUE RESPONSIVE : expand=True force le TextField à occuper 100% de la largeur
        self.text_rapport = ft.TextField(
            multiline=True, min_lines=10, max_lines=15, text_size=13, read_only=True,
            text_style=ft.TextStyle(font_family="Courier New"),
            border_color=ft.Colors.GREY_400, bgcolor="#f9fafb",
            expand=True
        )
        
        # 🎯 FIX HARMONISATION : expand=True appliqué sur la Colonne et le Container parent pour étirer le verdict
        ...
        # Structure globale empilée défilante unifiée mettant à jour l'appel du bouton
        self.layout_heritage = ft.Column([
            self.c_mode,
            self.cadre_res,
            self.btn_generer_pdf  # 🎯 Injection de la clé harmonisée
    ...
    def traduire_page(self, dic: dict):
        ...
        # ============================================================
        # 🎯 PARTIE 2A : CONFECTION DU RAPPORT TEXTUEL POUR L'ÉCRAN
        # ============================================================
    ...
    # ============================================================
    # 🎯 PARTIE 2B : COMPILATION DU CERTIFICAT SUCCESSORAL PDF
    # ============================================================
    ...
    def actualiser_donnees_affichage(self): 
        ...
        # 1. Calculer d'abord la masse, les fractions et le Hajb (Synchrone)
