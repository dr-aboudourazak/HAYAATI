...
class PageLangueArabe(ft.Container):
    ...
    def _construire_carte_flip(self, item, cle_etape):
        ...
        def construire_verso():
            ...
            lignes.append(ft.Column([
                ft.ElevatedButton("✓ Je la connais", bgcolor=VERT_SUCCES, color="white", height=28,
                                  style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                  on_click=lambda e: marquer(e, True)),
                ft.ElevatedButton("🔁 À revoir", bgcolor=AMBRE_ATTENTE, color="white", height=28,
                                  style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                  on_click=lambda e: marquer(e, False)),
    ...
    def _barre_pagination(self, page_actuelle, nb_pages, libelle, on_precedent, on_suivant):
        return ft.Row([
            ft.ElevatedButton("◂ Précédent", on_click=on_precedent, disabled=(page_actuelle == 0),
                              style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4))),
            ft.Text(libelle, size=11, color=TEXTE_FONCE),
            ft.ElevatedButton("Suivant ▸", on_click=on_suivant, disabled=(page_actuelle >= nb_pages - 1),
                              style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4))),
    ...
    def _construire_etape_alphabet(self, etape):
        ...
        return ft.Column([
            ...
            self._barre_pagination(self.etat.page_alphabet, nb_pages, f"Page {self.etat.page_alphabet + 1} / {nb_pages}", naviguer(-1), naviguer(1)),
        ], spacing=6)
    ...
    def _construire_etape_vocabulaire(self, etape):
        ...
        return ft.Column([
            ...
            self._barre_pagination(i_liste, len(listes), f"{i_liste + 1} / {len(listes)} — {liste.get('titre','')}", naviguer(-1), naviguer(1)),
        ], spacing=6)
    ...
    def _construire_etape_conjugaison(self, etape):
        ...
        return ft.Column([
            ...
            *blocs_note,
            ...
            self._barre_pagination(self.etat.page_conjugaison, nb_pages, f"Page {self.etat.page_conjugaison + 1} / {nb_pages}", naviguer(-1), naviguer(1)),
        ], spacing=6)
    ...
    def _construire_etape_grammaire(self, etape):
        ...
        carte = ft.Container(
            content=ft.Column(
                ...
                + [ft.Row([
                        ft.ElevatedButton("✓ J'ai compris", bgcolor=VERT_SUCCES, color="white", height=32,
                                          style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                          on_click=lambda e: marquer(e, True)),
                        ft.ElevatedButton("🔁 À revoir", bgcolor=AMBRE_ATTENTE, color="white", height=32,
                                          style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                          on_click=lambda e: marquer(e, False)),
                    ], spacing=8)],
    ...
    def _construire_etape_lecture(self, etape):
        ...
        return ft.Column([
            ...
            *vocab,
            ft.Row([
                ft.ElevatedButton("✓ J'ai lu ce texte", bgcolor=VERT_SUCCES, color="white", height=32,
                                  style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                  on_click=lambda e: marquer(e, True)),
                ft.ElevatedButton("🔁 À relire", bgcolor=AMBRE_ATTENTE, color="white", height=32,
                                  style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                  on_click=lambda e: marquer(e, False)),
            ], spacing=8),
            self._barre_pagination(self.etat.index_texte_lecture, len(textes), f"{self.etat.index_texte_lecture + 1} / {len(textes)} — {texte.get('titre','')}", naviguer(-1), naviguer(1)),
        ], spacing=6)
        ...
        return ft.Column([
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Row([
                        ft.ElevatedButton("✓ Je la maîtrise", bgcolor=VERT_SUCCES, color="white", height=32,
                                          style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                          on_click=lambda e: marquer(e, True)),
                        ft.ElevatedButton("🔁 Encore à revoir", bgcolor=AMBRE_ATTENTE, color="white", height=32,
                                          style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=4)),
                                          on_click=lambda e: marquer(e, False)),
                    ], spacing=8),
                ], spacing=6, tight=True),
            ...
            self._barre_pagination(self.etat.index_caravane, len(session), f"Étape {self.etat.index_caravane + 1} / {len(session)}", naviguer(-1), naviguer(1)),
        ], spacing=6)
