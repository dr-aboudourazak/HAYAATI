...
class PageProfil(ft.Container):
    def __init__(self, app_reference):
        ...
        for c in self.cles_champs:
            ...
            if c == "birth":
                ...
                self.cb_jour = ft.Dropdown(
                    ...
                    width=82, height=38, text_size=12, value="01", dense=True, bgcolor=ft.Colors.WHITE
                )
                ...
                self.cb_annee = ft.Dropdown(
                    ...
                    width=95, height=38, text_size=12, value="2000", dense=True, bgcolor=ft.Colors.WHITE
                )
        ...
        # Structure globale défilante unifiée
